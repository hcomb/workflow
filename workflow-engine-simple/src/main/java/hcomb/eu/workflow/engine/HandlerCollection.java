...
import hcomb.eu.workflow.engine.call.*;
...
class HandlerCollection {
    ...
    private static final class HandlerType {
        ...
        private HandlerType(EventType eventType, String event, String state) {
    ...
    public void setHandler(EventType eventType, String state, String event, Handler handler) {
        handlers.put(new HandlerType(eventType, event, state), handler);
    }

    @SuppressWarnings("unchecked")
	public <C extends StatefulContext> void callOnEventTriggered(String event, String stateFrom, String stateTo, C context) throws Exception {
    ...
    @SuppressWarnings("unchecked")
	public <C extends StatefulContext> void callOnStateEntered(String state, C context) throws Exception {
    ...
    @SuppressWarnings("unchecked")
	public <C extends StatefulContext> void callOnStateLeaved(String state, C context) throws Exception {
    ...
    @SuppressWarnings("unchecked")
	public <C extends StatefulContext> void callOnFinalState(String state, C context) throws Exception {
